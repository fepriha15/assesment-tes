package id.android.pokeapp.model
...
data class PokemonSprites(val backDefault: String?,
...
data class Other(val dreamWorld: DreamWorld? = null, @SerializedName("official-artwork")val officialArtwork: OfficialArtwork? = null) : Serializable

data class OfficialArtwork(val frontDefault: String? = null) : Serializable

data class DreamWorld(val frontDefault: String? = null, val frontFemale: Any? = null) : Serializable

data class PokemonAbility(val isHidden: Boolean, val slot: Int, val ability: NamedApiResource) : Serializable

data class PokemonHeldItem(val item: NamedApiResource, val versionDetails: List<PokemonHeldItemVersion>) : Serializable

data class PokemonHeldItemVersion(val version: NamedApiResource, val rarity: Int) : Serializable

data class PokemonMove(val move: NamedApiResource, val versionGroupDetails: List<PokemonMoveVersion>) : Serializable

data class PokemonMoveVersion(val moveLearnMethod: NamedApiResource, val versionGroup: NamedApiResource, val levelLearnedAt: Int) : Serializable

data class PokemonStat(val stat: NamedApiResource, val effort: Int, val baseStat: Int) : Serializable

data class PokemonType(val slot: Int, val type: NamedApiResource) : Serializable
...
data class PokemonForm(val id: Int,
                       val name: String,
                       val order: Int,
                       val formOrder: Int,
                       val isDefault: Boolean,
...
data class PokemonSpecies(val id: Int,
                          val name: String,
                          val order: Int,
                          val genderRate: Int,
                          val captureRate: Int,
...
data class TypeRelations(val noDamageTo: List<NamedApiResource>,
