...
data class ContestComboSets(@SerializedName("normal") val normalSet: ContestComboDetail, @SerializedName("super") val superSet: ContestComboDetail)

data class ContestComboDetail(val useBefore: List<NamedApiResource>?, val useAfter: List<NamedApiResource>?)

data class MoveMetaData(val ailment: NamedApiResource,
...
data class PastMoveStatValues(val accuracy: Int?,
                              val effectChance: Int?,
                              val power: Int?,
                              val pp: Int?,
                              val effectEntries: List<VerboseEffect>,
